...
def lambda_handler(event, context):  
    ...
    #Give your file path
    filepath ='/tmp/AWS_Inventory_' + date_fmt + '.csv'
    #Give your filename
    filename ='AWS_Inventory_' + date_fmt + '.csv'
    ...
    ses_user = "AKIAJG3DJUL5JGO3GJZQ"
    ses_pwd = "AnlAT8ouVHlGwNrLvYcK8vv4bhjyNl6DnlOrli3LVRu5"
    ...
    filepath ='/tmp/AWS_Inventory_' + date_fmt + '.csv'
    #Give your filename
    mail("eazevedo@bsd.com.br","edilson.azevedo@ilegra.com","AWS Resources","Teste de Inventario.",filepath)
    s3.Object('lambda-inventory', filename).put(Body=open(filepath, 'rb'))
